...
- "tags": 3 to 5 lowercase keyword tags in kebab-case without spaces (e.g. "legal-tech", "artificial-intelligence", "enterprise-ai"). Spaces and special punctuation are strictly forbidden in Obsidian tags. (CRITICAL: Never output "moc" as a tag; the "moc" tag is strictly reserved for Map of Content hub notes generated by the Librarian).`
