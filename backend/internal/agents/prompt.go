...
- "tags": 3 to 5 lowercase keyword tags. (CRITICAL: Never output "moc" as a tag; the "moc" tag is strictly reserved for Map of Content hub notes generated by the Librarian).`
